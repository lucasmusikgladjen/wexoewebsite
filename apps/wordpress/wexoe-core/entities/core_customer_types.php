<?php
/**
 * Entity schema: core_customer_types (shim)
 *
 * Faltlistan bor pa EXAKT ett stalle: schema/core_customer_types.json (committad synk-kopia av
 * packages/schema/entities/core_customer_types.json). Den har filen ar en tunn shim som later
...
return \Wexoe\Core\Schema::from_json('core_customer_types');
