<?php
/**
 * Entity schema: cms_cases (shim)
 *
 * Faltlistan bor pa EXAKT ett stalle: schema/cms_cases.json (committad synk-kopia av
 * packages/schema/entities/cms_cases.json). Den har filen ar en tunn shim som later
...
return \Wexoe\Core\Schema::from_json('cms_cases');
