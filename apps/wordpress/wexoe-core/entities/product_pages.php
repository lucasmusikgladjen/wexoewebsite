<?php
/**
 * Entity schema: product_pages (shim)
 *
 * Faltlistan bor pa EXAKT ett stalle: schema/product_pages.json (committad synk-kopia av
 * packages/schema/entities/product_pages.json). Den har filen ar en tunn shim som later
...
return \Wexoe\Core\Schema::from_json('product_pages');
