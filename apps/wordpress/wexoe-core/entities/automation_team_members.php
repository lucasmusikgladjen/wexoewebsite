<?php
/**
 * Entity schema: automation_team_members (shim)
 *
 * Faltlistan bor pa EXAKT ett stalle: schema/automation_team_members.json (committad synk-kopia av
 * packages/schema/entities/automation_team_members.json). Den har filen ar en tunn shim som later
...
return \Wexoe\Core\Schema::from_json('automation_team_members');
