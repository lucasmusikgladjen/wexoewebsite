<?php
/**
 * Entity schema: automation_offerings (shim)
 *
 * Faltlistan bor pa EXAKT ett stalle: schema/automation_offerings.json (committad synk-kopia av
 * packages/schema/entities/automation_offerings.json). Den har filen ar en tunn shim som later
...
return \Wexoe\Core\Schema::from_json('automation_offerings');
