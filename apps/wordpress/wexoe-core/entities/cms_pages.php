<?php
/**
 * Entity schema: cms_pages (shim)
 *
 * Faltlistan bor pa EXAKT ett stalle: schema/cms_pages.json (committad synk-kopia av
 * packages/schema/entities/cms_pages.json). Den har filen ar en tunn shim som later
...
return \Wexoe\Core\Schema::from_json('cms_pages');
