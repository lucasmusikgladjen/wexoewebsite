<?php
/**
 * Entity schema: products (shim)
 *
 * Faltlistan bor pa EXAKT ett stalle: schema/products.json (committad synk-kopia av
 * packages/schema/entities/products.json). Den har filen ar en tunn shim som later
...
return \Wexoe\Core\Schema::from_json('products');
