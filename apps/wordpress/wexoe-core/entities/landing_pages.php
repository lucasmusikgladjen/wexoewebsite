<?php
/**
 * Entity schema: landing_pages (shim)
 *
 * Faltlistan bor pa EXAKT ett stalle: schema/landing_pages.json (committad synk-kopia av
 * packages/schema/entities/landing_pages.json). Den har filen ar en tunn shim som later
...
return \Wexoe\Core\Schema::from_json('landing_pages');
