...
import { ProductPageState, LinkedSolution, emptyLinkedSolution } from '@/lib/product-page-types';
...
export default function SolutionsEditor({ state, onChange }: SectionEditorProps<ProductPageState>) {
