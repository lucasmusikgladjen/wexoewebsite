...
import { ProductPageState, NormalSection } from '@/lib/product-page-types';
...
export default function ContentBlocksEditor({ state, onChange }: SectionEditorProps<ProductPageState>) {
