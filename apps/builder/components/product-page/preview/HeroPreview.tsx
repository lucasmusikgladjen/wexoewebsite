...
function NpiCard({ state }: { state: ProductPageState }) {
  return (
    <div
      style={{
        flex: '2 1 0%',
...
function HeroBenefits({ state, textColor }: { state: ProductPageState; textColor: string }) {
...
function HeroImage({ state }: { state: ProductPageState }) {
  return (
